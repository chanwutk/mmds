...
def promote_vehicle_trajectory_row(row: dict[str, Any]) -> dict[str, Any]:
    """Map UDF: lift Unnest(``vehicles``) items to the rewrite trajectory schema."""
    return _impl.promote_vehicle_trajectory_row(row)
